 ...
 */
class block_cpm_completionstatus extends block_base {
    ...
    public function init() {
        ...
        $this->title = get_string('pluginname', 'block_cpm_completionstatus');
    }
    ...
    public function get_content() {
        ...
        if ($info->is_tracked_user($USER->id)) {
            ...
            if (!empty($activities)) {
                ...
                $row->cells[1] = new html_table_cell(get_string('firstofsecond', 'block_cpm_completionstatus', $a));
                $row->cells[1]->style = 'text-align: right;';
                $srows[] = $row;
            }
            ...
            $details = new moodle_url('/blocks/cpm_completionstatus/details.php', array('course' => $course->id));
