...
namespace block_cpm_completionstatus;

use advanced_testcase;
use block_cpm_completionstatus;
use context_course;
 ...
 */
class cpm_completionstatus_test extends advanced_testcase {
    public static function setUpBeforeClass(): void {
        require_once(__DIR__ . '/../../moodleblock.class.php');
        require_once(__DIR__ . '/../block_cpm_completionstatus.php');
    }
    ...
    public function test_can_block_be_added(): void {
        ...
        $block = new block_cpm_completionstatus();
